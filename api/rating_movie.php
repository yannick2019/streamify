...
if ($_SERVER['REQUEST_METHOD'] === 'OPTIONS') {
    ...
    $query = "SELECT rating_count, total_rating FROM movies WHERE id = $movieId";
    ...
    $updateQuery = "UPDATE movies SET rating_count = $newRatingCount, total_rating = $newTotalRating WHERE id = $movieId";
    mysqli_query($conn, $updateQuery);

    // Calculate and update the average rating (optional)
    $averageRating = $newTotalRating / $newRatingCount;
    $updateAverageQuery = "UPDATE movies SET vote_average = $averageRating WHERE id = $movieId";
